 ...
 * Returns an object of {obj, key}.
 */
function pathToObjectKey(document, path) {
  if (path) {
...
function applyOperation(document, operation) {
  ...
  if (operation.path === "") {
    ...
    // Apply patch
    if (Array.isArray(obj)) {
      return arrOps[operation.op].call(operation, obj, key, document);
    } else {
      return objOps[operation.op].call(operation, obj, key, document);
    }
  }
}
